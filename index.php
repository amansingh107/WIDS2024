...
<div class="modal" tabindex="-1" role="dialog" id="myModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
     “Mentee Registration is active till 27th November”
      </div>
      <div class="modal-footer">
        <!--button type="button" class="btn btn-primary">Save changes</button-->
        <!--button type="button" class="btn btn-outline-danger" data-dismiss="modal">Close</button-->
...
<section id="portfolio" class="bg-light-gray" style="background-color: white;">
    ...
    <section id="about" style="background-color:#fff;">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="content">
                                    ...
                                    <p class="description">
                                        ...
                                        <br>
                                        <b>Deadline: 11.59 PM on Sunday, 27th November 2024.</b>
                                    </p>
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="content">
                                    ...
                                    <p class="description">
                                        ...
                                        <br>
                                        <b>Timeline: 27th November ‘24 to 4th December ‘24
                                        </b>
                                    </p>
        ...
        <br>
        <br>
        <h3 style="text-align: center;">All selections will be declared by 5th December 2024 and the project work will begin immediately.
